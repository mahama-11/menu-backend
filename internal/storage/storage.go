...
func preAutoMigrate(db *gorm.DB, tablePrefix string) error {
	...
	if tablePrefix != "" {
		renames := [][2]string{
			...
			{"template_catalogs", tablePrefix + "template_catalogs"},
			{"template_catalog_versions", tablePrefix + "template_catalog_versions"},
			{"template_catalog_examples", tablePrefix + "template_catalog_examples"},
			{"template_favorites", tablePrefix + "template_favorites"},
			{"template_usage_events", tablePrefix + "template_usage_events"},
