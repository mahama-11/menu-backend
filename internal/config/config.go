...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("studio.single_billable_item", "menu.render.call")
	v.SetDefault("studio.refinement_billable_item", "menu.render.call")
	v.SetDefault("studio.variation_billable_item", "menu.render.call")
