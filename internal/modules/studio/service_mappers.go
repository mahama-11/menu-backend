...
func (s *Service) mapGenerationJob(item *models.GenerationJob, variants []models.GenerationVariant, childJobs []models.GenerationJob, chargeIntent *models.StudioChargeIntent) *GenerationJobSummary {
	...
	out := &GenerationJobSummary{
		...
		UserID:             item.UserID,
		Mode:               item.Mode,
		InputMode:          firstNonEmpty(stringMapValue(paramsSnapshot, "input_mode"), stringMapValue(metadata, "input_mode")),
		GenerationStrategy: firstNonEmpty(stringMapValue(paramsSnapshot, "generation_strategy"), stringMapValue(metadata, "generation_strategy")),
		Status:             item.Status,
		Stage:              item.Stage,
